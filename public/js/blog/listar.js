...
$(document).ready(function() {
    $('#tablaEntradas').DataTable({
        language: {
            ...
            search: "", 
            searchPlaceholder: "Buscar usuario por título, fecha o estado..."
        },
        ...
        columns: [
            ...
            { data: 'titulo', title: 'Título', width: '25%' },
            { data: 'estado', title: 'Estado', width: '20%' },
            { data: 'scope', title: 'Scope', width: '15%' },
            { 
