...
$(document).ready(function() {
    $('#tablaExperiencias').DataTable({
        language: {
            ...
            search: "", 
            searchPlaceholder: "Buscar experiencia laboral por cargo, organización o fecha..."
        },
        data: window.experiencias,
        responsive: true,
        paging: true,
        lengthChange: false,
        searching: true,
        ...
        columns: [
            ...
            { data: 'cargo', title: 'Cargo', width: '20%' },
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        <div class="text-center">
                            ...
                            <button class="btn btn-sm btn-danger-custom" onclick="eliminarExperiencia(${row.id})" title="Eliminar">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 16px; height: 16px;">
