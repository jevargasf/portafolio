<x-layouts.main-panel>
    <div class="card card__profile">
        <div class="card__body">
            ...
            <h3 class="profile__title">Hola, {{ auth()->user()->nombres }}</h3>
            <p class="profile__text">¿Cómo deseas ingresar hoy?</p>
            ...
            <form action="{{ route('auth.seleccionar-perfil') }}" method="POST">
                ...
                <div class="profile__buttons">
                    ...
                    <button type="submit" name="perfilId" value="1" class="profile__button--select">
                            ...
                            <div class="profile__button--text">
                                <h5 class="profile__button--title">Modo Administrador</h5>
                                <small class="profile__button--description">Gestión de usuarios y sistema</small>
                            </div>
                    </button>

                    <button type="submit" name="perfilId" value="2" class="profile__button--select">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM7 12H9C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12H17C17 14.7614 14.7614 17 12 17C9.23858 17 7 14.7614 7 12Z"></path></svg>
                            </div>
                            <div class="profile__button--text">
                                <h5 class="profile__button--title">Mi Panel</h5>
                                <small class="profile__button--description">Ver mis proyectos y perfil</small>
                            </div>
                        </button>
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="profile__button--ghost">
