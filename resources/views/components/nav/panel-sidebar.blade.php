  <ul class="nav flex-row flex-md-column w-100 bg-light align-items-center align-items-md-stretch justify-content-around justify-content-md-start h-auto h-md-100 p-2 p-md-4" id="sidebar">
      <li class="d-none d-md-flex">
        <a class="navbar-brand p-2 align-middle d-flex align-items-center mb-4 w-100 justify-content-center justify-content-md-start " href="{{ route('inicio') }}">
          ...
          <span class="d-none d-md-block fw-bold">
              Un saludo desde lenovo
          </span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center w-100 justify-content-center justify-content-md-start {{ request()->routeIs('panel.inicio') ? 'active' : '' }}" 
            href="{{ route('panel.inicio') }}">
            <svg class="me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19H18V9.15745L12 3.7029L6 9.15745V19ZM19 21H5C4.44772 21 4 20.5523 4 20V11L1 11L11.3273 1.6115C11.7087 1.26475 12.2913 1.26475 12.6727 1.6115L23 11L20 11V20C20 20.5523 19.5523 21 19 21ZM7.5 13H9.5C9.5 14.3807 10.6193 15.5 12 15.5C13.3807 15.5 14.5 14.3807 14.5 13H16.5C16.5 15.4853 14.4853 17.5 12 17.5C9.51472 17.5 7.5 15.4853 7.5 13Z"></path></svg> 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center w-100 justify-content-center justify-content-md-start {{ request()->routeIs('panel.proyectos.*') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center w-100 justify-content-center justify-content-md-start {{ request()->routeIs('panel.perfil.*') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center w-100 justify-content-center justify-content-md-start {{ request()->routeIs('panel.blog.*') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center w-100 justify-content-center justify-content-md-start {{ request()->routeIs('public.inicio') ? 'active' : '' }}" 
    ...
    <li class="nav-item mt-md-auto pt-md-4 border-top">
      <a class="nav-link d-flex align-items-center w-100 justify-content-center justify-content-md-start " href="{{ route('auth.form-seleccionar-perfil') }}">
    ...
    <li class="nav-item d-none d-md-flex"> 
      ...
      <a class="nav-link text-danger d-flex align-items-center w-100 justify-content-center justify-content-md-start " href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
