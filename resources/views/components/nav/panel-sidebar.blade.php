  <ul class="nav flex-row flex-md-column w-100 bg-light align-items-center align-items-md-stretch justify-content-around justify-content-md-start h-auto h-md-100 p-2 p-md-4" id="sidebar">
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('panel.inicio') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('panel.proyectos.*') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('panel.perfil.*') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('panel.blog.*') ? 'active' : '' }}" 
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('public.inicio') ? 'active' : '' }}" 
    ...
    <li class="nav-item mt-auto pt-4 border-top">
      <a class="nav-link d-flex align-items-center" href="{{ route('auth.form-seleccionar-perfil') }}">
