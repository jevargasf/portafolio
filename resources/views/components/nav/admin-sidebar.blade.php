<ul class="nav flex-column p-4" id="sidebar">
  <a class="navbar-brand p-2 align-middle" href="#">
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="{{ route('admin.dashboard') }}">Inicio</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="{{ route('admin.usuarios.listar') }}">Usuarios</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">Historial de accesos</a>
  </li>
